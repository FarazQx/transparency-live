    ...
    <Box px={'25px'}>
      ...
      <Tabs position="relative" variant="unstyled">
        <TabList color={"primary"} gap={2}>
          ...
          <Tab bg={"secondaryGray.100"} borderTopRadius={"lg"} h="35px" onClick={() => setSelectedStatus(3)}>
            Assigned
          </Tab>
          <Tab bg={"secondaryGray.100"} borderTopRadius={"lg"} h="35px" onClick={() => setSelectedStatus(4)}>
            In Progress
          </Tab>
          <Tab bg={"secondaryGray.100"} borderTopRadius={"lg"} h="35px" onClick={() => setSelectedStatus(6)}>
            Completed
          </Tab>
          {/* <Tab bg={"secondaryGray.100"} borderTopRadius={"lg"} h="35px" onClick={() => setSelectedStatus('Billed')}>
            Billed
          </Tab> */}
          <Tab bg={"secondaryGray.100"} borderTopRadius={"lg"} h="35px" onClick={() => setSelectedStatus(7)}>
            Cancelled
          </Tab>
        </TabList>
        <TabIndicator
            ...
            return (
              <Tr {...row.getRowProps()} key={index}>
                ...
                >
                  ...
                  <TableMenu icon={<Icon as={IoEllipsisVertical} h='18px' w='19px' color={textColor} />} />
                  </Flex>
                </Td>
              </Tr>
            );
